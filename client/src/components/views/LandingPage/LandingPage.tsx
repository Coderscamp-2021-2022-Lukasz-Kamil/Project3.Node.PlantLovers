...
const LandingPage = () => {
  ...
  const LandingPageCardText = styled.p`
    padding-bottom: 20px;
  ...
  `;
  const LandingPageCardTextMobile = styled.p`
    display: none;
  ...
  const LandingPageCardHeading = styled.p`
    margin: 10px 0 20px;
    font-size: ${({ theme }) => theme.size.desktop.xxl}px;
